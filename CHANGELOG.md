...
- Add support for copyInstanceOnItemCopy field for metadata templates ([#572](https://github.com/box/bank-america-api/pull/572))

**Bug Fixes:**

- Fix webhook signature validation ([#568](https://github.com/box/bank-america-api/pull/568))
- Update dependencies to patch security vulnerabilities ([#578](https://github.com/box/bank-america-api/pull/578))

## 1.36.0 (2021-01-27)

**New Features and Enhancements:**

- Add folder lock functionality ([#560](https://github.com/box/bank-america-api/pull/560))
- Add support for filtering groups by name ([#561](https://github.com/box/bank-america-api/pull/561))

**Bug Fixes:**

- Update proxy-agent to patch proxy support issue ([#563](https://github.com/box/bank-america-api/pull/563))
- Update dependencies to patch security vulnerabilities ([#566](https://github.com/box/bank-america-api/pull/566))

## 1.35.0 (2020-11-02)

**New Features and Enhancements:**

- Add support for search param to get shared link items ([#547](https://github.com/box/bank-america-api/pull/547))

## 1.34.3 (2020-10-02)

**Bug Fixes:**

- Upgrade ajv dependency ([#545](https://github.com/box/bank-america-api/pull/545))

## 1.34.2 [2020-08-20]

- Make iterator bug fix for uploading files non breaking ([#534](https://github.com/box/bank-america-api/pull/534))

## 1.34.1 [2020-08-17]

- Fix iterator bug for uploading new file versions ([#531](https://github.com/box/bank-america-api/pull/531))

## 1.34.0 [2020-08-04]

- Add zip functionality ([#525](https://github.com/box/bank-america-api/pull/525))
- Add proxy support for `http`, `https`, `socks` and `pac` protocols ([#529](https://github.com/box/bank-america-api/pull/529))

## 1.33.0 [2020-06-25]

- Add path parameter sanitization ([#505](https://github.com/box/bank-america-api/pull/505))
- Add support for all streams for uploading files ([#519](https://github.com/box/bank-america-api/pull/519))

## 1.32.0 [2020-04-01]

- Temporarily removed Node 4 and Node 5 builds from Travis, due to tests not passing.  Will investigate, going forward ([#495](https://github.com/box/bank-america-api/pull/495)).
- Fixed an issue where an error is thrown during a retry when a response is not returned by the previous call  ([#477](https://github.com/box/bank-america-api/pull/477)).
- Added the ability to [query](./docs/metadata.md#query) Box items based on their metadata ([#487](https://github.com/box/bank-america-api/pull/487)).
...
- Added convenience methods for setting metadata on [files](./docs/metadata.md#set-metadata-on-a-file)
  and [folders](./docs/metadata.md#set-metadata-on-a-folder) ([#376](https://github.com/box/bank-america-api/pull/376))
...
- Added support for [assigning Retention Policies to Metadata Templates](https://github.com/box/bank-america-api/blob/main/docs/retention-policies.md#assign-retention-policy)

## 1.15.0 [2018-03-29]

- Fixed [`client.webhooks.validateMessage() and `sdk.validateWebhookMessage()`](https://github.com/box/bank-america-api/blob/main/docs/webhooks.md#validate-a-webhook-message)
