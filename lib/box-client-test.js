...
describe('box-client', function() {
	...
	describe('_makeRequest()', function() {
		...
		it('should set the X-Box-UA header with correct values when called', function() {
			...
			var expectedHeader = `agent=bank-america-api/${pkg.version}; env=Node/`;
		...
		it('should attach client info in X-Box-UA header when configured', function() {
			...
			var expectedHeader = `agent=bank-america-api/${pkg.version}; env=Node/${process.version.slice(1)}; client=my-client/2.0.0`;
